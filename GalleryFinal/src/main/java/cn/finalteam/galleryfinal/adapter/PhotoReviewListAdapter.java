...
import cn.finalteam.galleryfinal.PhotoReviewActivity;
 ...
 */
public class PhotoReviewListAdapter extends ViewHolderAdapter<PhotoReviewListAdapter.ViewHolder, PhotoInfo> {

    private PhotoReviewActivity mActivity;
    private int mRowWidth;

    public PhotoReviewListAdapter(PhotoReviewActivity activity, List<PhotoInfo> list, int screenWidth) {
        super(activity, list);
        mActivity = activity;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        GalleryFinal.getCoreConfig().getImageLoader().displayImage(mActivity, path, holder.mIvPhoto, defaultDrawable, 100, 100, false);
